		...
		<Container style={{paddingTop: "10rem", paddingBottom: "10rem"}}>
			<Row>
				...
				<Col className="overview-col" lg="6" sm="12">
					...
					<p>
						Low Rise Condo-Floors at DLF Garden City Enclave in Sector 93
						of Millennium City, Gurgaon, provide investors another chance
						after the tremendous success of Phase II, III, IV and Garden
						City Independent Floors. The leader in the real estate market,
						DLF, has created the exclusive gated low-rise neighbourhood
						known as Garden City Enclave. The self-contained city is home
						to a strong social and commercial infrastructure in addition
						to a wealth of natural beauty, including numerous beautiful
						green gardens. Residents of New Gurugram want Independent
						Floors as their ultimate destination.
					</p>
					<Button
			...
			<Row style={{margin: "5rem 0"}}>
				<Grid container>
					...
					<Grid item xs={2}>
						<Box className="prop_item">
							<GamepadIcon sx={{fontSize: "6rem", color: "#57cc99"}} />
					...
					<Grid item xs={2}>
						<Box className="prop_item">
							<LocalAtmIcon sx={{fontSize: "6rem", color: "#57cc99"}} />
							<span className="prop_title">Pricing</span>
							<span className="prop_subtitle">₹ 1.25 Cr.* Onwards</span>
						</Box>
					</Grid>
					<Grid item xs={2}>
						<Box className="prop_item">
					...
					<Grid item xs={2}>
						<Box className="prop_item">
							<ExploreIcon sx={{fontSize: "6rem", color: "#57cc99"}} />
